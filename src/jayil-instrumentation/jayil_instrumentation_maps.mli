...
(** Returns true if the ident was added during instrumentation, false otherwise. *)

val get_pre_inst_equivalent_clause : t -> Ast.ident -> Ast.clause
(** Get an odefa clause that existed before the odefa program was instrumented.
    If the odefa var was added during type instrumentation, it will return the
    clause representing the constrained operation. If the var was added before,
    it will return the clause it identified before instrumentation. *)
