...
val add_on_expr_to_expr_mapping : t -> Jay_ast.expr_desc -> Jay_ast.expr_desc -> t;;
...
val add_on_idents_to_type_mapping : t -> Jay_ast.Ident_set.t -> Jay_ast.type_sig -> t;;
...
(** Given a natodefa expression, returns the corresponding variable in desugared
    odefa. *)
val get_odefa_var_opt_from_natodefa_expr : t -> Jay_ast.expr_desc -> Ast.var option;;
