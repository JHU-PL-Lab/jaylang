...
val of_options : (unit, t * Symbolic_session.t) Options.Fun.a
...
val accum_symbolic : t -> Symbolic_session.t -> t
(** [accum_symbolic t sym] finishes the sybolic session [sym] and accumulates results into [t]. *)

val next : t -> [ `Done of Status.t | `Next of (t * Symbolic_session.t) ] Lwt.t
