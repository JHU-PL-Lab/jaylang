...
(** Takes expressions e1 and e2 as arguments. Returns 0 if the two expressions
    have equal precedence, a negative int if e1 has lower precedence than e2,
    and a positive int if e1 has higher precedence. *)
