...
opam install core core_unix psq hashcons ocamlgraph z3 fmt ppx_deriving yojson ppx_deriving_yojson lwt_ppx landmarks-ppx jhupllib monadlib pds-reachability alcotest-lwt
```
