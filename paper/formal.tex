...
Typechecking is defined by the following model relation:

\begin{definition}[Model relation]
  \label{def_typingM}
...
\begin{definition}[Updated model relation]
  \ \par
...
\begin{definition}[More model relations]
...
\begin{definition}[Record model relation]
  \label{def_typingRec}
  % \label{def_ppred} \label{def_ifx} \label{def_ifbranch} \label{def_retcl}
  \ \par
  \begin{enumerate}
