...
\newcommand{\genf}{\texttt{generator}}
\newcommand{\chef}{\texttt{checker}}
\newcommand{\pick}{\texttt{pick}}
\newcommand{\take}[2]{\texttt{take}(#1, #2)}
\newcommand{\mzero}{\texttt{mzero}}

\newcommand{\hastype}[2]{#1\ \colon #2}
\newcommand{\mkfun}[2]{#1 \texttt{ -> } #2}
\newcommand{\mkfunv}[2]{\texttt{fun }#1 \texttt{ -> } #2}
...
\newcommand{\mkche}[2]{\texttt{checker}(#1, #2)}
\newcommand{\evaluate}[1]{\texttt{eval}(#1)}
\newcommand{\letfun}{\texttt{let f x = e in e}}
\newcommand{\letfunt}{\texttt{let f (x : \syntype) : \syntype \ = e in e}}
\newcommand{\eerror}{\texttt{ERROR}}
...
\newcommand{\nsmallsteps}[1][]{\mathrel{\longarrownot\longrightarrow^*_{#1}}}
...
\newcommand{\matches}[2]{#1 \ \tttilde \ #2}
\newcommand{\ife}[3]{\texttt{if } #1 \texttt{ then } #2 \texttt{ else }#3}
\newcommand{\letin}[3]{\texttt{let }#1\texttt{ = }#2\texttt{ in }#3}
\newcommand{\letint}[4]{\texttt{let (}#1\texttt{ : #2) = }#3\texttt{ in }#4}
\newcommand{\redcon}[2]{R[#1]\textbf{[}#2\textbf{]}}
